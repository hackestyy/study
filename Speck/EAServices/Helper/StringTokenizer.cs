...
namespace ZteApp.ProductService.EAServices.Helper
{
	...
	public class StringTokenizer
	{
        ...
        /// <summary>
        /// reads AlphaNumeric. AlphaNumeric contains any alpha character or _ or numerical
        /// </summary>
        protected Token ReadAlphaNumeric()
        {
            StartRead();
            ...
            return CreateToken(TokenKind.AlphaNumeric);
        }
